...
**Последнее обновление:** 2026-05-29 (v3.2.1–v3.2.4 завершены, 341 тест проходит)
...
| v3.2.5 | Авто-скип mapping | 🔜 **СЛЕДУЮЩИЙ** | Пропуск mapping при распознанном формате (флажок в настройках) |
