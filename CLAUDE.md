...
|-----|-----|------|--------|-------|
| 1 | Обновить §11: добавить Free login как критический DoD | SPEC.md | ~100 | Документ фиксирует приоритет |
| 2 | Добавить в §10: Free login = required для retention loop | SPEC.md | ~50 | Known limitations обновить |
| 3 | Обновить CLAUDE.md roadmap: Free login = v4 priority | CLAUDE.md | ~100 | AI не предложит v4 пока не исправлено |
| 4 | Код: Free login → save 1 snapshot, show MoM delta | код | ~300-500 | Бизнес-эффект |
| 5 | Тесты + коммит | тесты | ~100 | Не сломать |
