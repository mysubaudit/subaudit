...
**Последнее обновление:** 2026-05-29 (v3.2.1 + v3.2.2 завершены, 333 тестов проходят)
...
| v3.2.3 | Интеграция в upload flow | 🔜 **СЛЕДУЮЩИЙ** | Вызов detect_preset() после парсинга CSV, сохранение в session_state |
...
"**v3.2.3 — Интеграция в upload flow** (SPEC.md §8 v3.2.3)
